...
import com.artronics.chapar.device.driver.buffer.BufferDistributor;
...
public class DeviceDriverSerialPort implements DeviceDriver, SerialPortEventListener {
    ...
    @Value("${com.artronics.chapar.device.driver.connection_string}")
    public void setConnectionString(String connectionString) {
        this.connectionString = connectionString;
    }

    @Value("${com.artronics.chapar.device.driver.timeout}")
